...
/* =============================================
   JAVASCRIPT MOBILE CENTERING FIX
...
function fixMobileAlignment() {
  if (window.innerWidth <= 768) {
    ...
    if (homeSection) {
      ...
      homeSection.style.maxWidth = '100vw';
      homeSection.style.margin = '0';
      homeSection.style.padding = '2rem 0';
      ...
      const children = homeSection.children;
      for (let child of children) {
        child.style.margin = '0 auto';
        child.style.textAlign = 'center';
        child.style.width = '100%';
        child.style.maxWidth = '90%';
      ...
      const textElements = homeSection.querySelectorAll('h1, h2, h3, p, span, div');
      ...
      // Center buttons
      const buttons = homeSection.querySelectorAll('a, button, .btn');
      buttons.forEach(btn => {
...
// Run on page load
window.addEventListener('DOMContentLoaded', fixMobileAlignment);

// Run on resize
window.addEventListener('resize', fixMobileAlignment);
